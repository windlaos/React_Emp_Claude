  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-bold dark:text-white">직원 목록</h1>
        <button
      ...
      <div className="flex flex-col gap-3 mb-6">
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            className="border border-gray-300 dark:border-gray-600 rounded px-3 py-2 text-sm bg-white dark:bg-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-400 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <option value="">전체 ({employees.length}명)</option>
            {departments.map((dept) => {
              const count = employees.filter((emp) => emp.department?.id === dept.id).length;
              return (
        ...
        <form onSubmit={handleSearch} className="flex gap-2">
          <input
            ...
            className="flex-1 border border-gray-300 dark:border-gray-600 rounded px-3 py-2 bg-white dark:bg-gray-800 dark:text-white dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-400"
          />
          <button
            type="submit"
      ...
      {isSearchActive && (
        <div className="mb-6">
          ...
          {searchState === SEARCH_STATE.NOT_FOUND && (
            <p className="text-center text-gray-500 dark:text-gray-400 py-8 bg-white dark:bg-gray-800 rounded-lg shadow">
